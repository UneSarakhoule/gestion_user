...
{"R_queryCanceled","La consulta se ha cancelado."},
{"R_errorReadingStream","Error al leer el valor del objeto de secuencia. Error: \"{0}\""},
{"R_read","La operación de lectura de secuencia devolvió un valor no válido para la cantidad de datos leídos."},
...
{"R_transactionsNotSupported","No se admite '@@TRANCOUNT'."},
...
{"R_errorServerName","El valor de la propiedad de conexión serverName {0} tiene un formato incorrecto."},
...
{"R_invalidDatetimeType","La propiedad de conexión {0} de datetimeType no es válida."},
...
{"R_colNotMatchTable","El número de columnas proporcionadas {0} no coincide con el de definición de tabla {1}."},
{"R_invalidSQL","Consulta SQL {0} no válida."},
{"R_multipleQueriesNotAllowed","No se permiten varias consultas."},
{"R_endOfQueryDetected","Se detectó el final de la consulta antes de que se encontraran VALORES."},
{"R_onlyFullParamAllowed","En este momento solo se permiten consultas totalmente parametrizadas para usar la API de copia masiva para la inserción por lotes."},
...
{"R_sslFailed","La propiedad \"encrypt\" está establecida en \"{0}\" y la propiedad \"trustServerCertificate\" está establecida en \"{1}\", pero el controlador no pudo establecer una conexión segura a SQL Server mediante el cifrado de Capa de sockets seguros (SSL): Error: {2}."},
...
{"R_iPAddressPreferencePropertyDescription","El tipo preferido de dirección IP."},
...
{"R_serverCertificatePropertyDescription","Ruta de acceso al archivo de certificado de servidor."},
{"R_prepareMethodPropertyDescription","Determina el método de preparación utilizado en el controlador."},
...
{"R_datetimeParameterTypePropertyDescription","Determina el tipo de datos que se va a usar para los valores datetime y timestamp. Se pueden usar las opciones: datetime, datetime2 o datetimeoffset"},
...
{"R_clientCertificatePropertyDescription","Ruta de acceso del certificado de cliente."},
{"R_clientKeyPropertyDescription","Ruta de acceso del archivo de clave privada para el certificado de cliente."},
...
{"R_accessTokenCallbackClassPropertyDescription","Clase de la que se va a crear una instancia como SQLServerAccessTokenCallback para adquirir tokens."},
{"R_accessTokenCallbackPropertyDescription","Objeto SQLServerAccessTokenCallback que se usa para llamar a un método de devolución de llamada para devolver un token de acceso."},
...
{"R_CryptoCacheInaccessible","Error {0} al intentar realizar operaciones de caché criptográfica de sesión: {1} "},
...
{"R_ManagedIdentityAuthenticationWithPassword","No se puede usar \"Authentication={0}\" con la palabra clave de cadena de conexión \"Password\"."},
...
{"R_AccessTokenCallbackWithUserPassword","No se puede establecer la devolución de llamada del token de acceso si se ha establecido \"User\", \"UserName\" o \"Password\"."},
{"R_AccessTokenCannotBeEmpty","AccessToken no puede estar vacío."},
...
{"R_NoUserOrCertForActiveServicePrincipalCertificate","Se debe especificar la palabra clave de cadena de conexión \"UserName\" y \"clientCertificate\" si es \"Authentication=ActiveDirectoryServicePrincipalCertificate\"."},
...
{"R_VerifySignatureFailed","No se puede verificar la firma de la clave de cifrado de columna."},
{"R_SignatureNotMatch","La firma de la clave de cifrado de columna cifrada \"{0}\" especificada no coincide con la firma \"{1}\" calculada con la clave maestra de columna (certificado) en \"{2}\". La clave de cifrado de columna cifrada puede estar dañada o la ruta especificada puede ser incorrecta. {3}"},
{"R_CEKSignatureNotMatchCMK","La firma de clave de cifrado de columna cifrada especificada \"{0}\" no coincide con la firma calculada con la clave maestra de columna (clave asimétrica en Azure Key Vault) en {1}. La clave de cifrado de columna cifrada puede estar dañada o la ruta especificada es incorrecta."},
...
{"R_InvalidWindowsCertificateStoreSignCMK","No se pueden firmar los metadatos de la clave maestra de columna con el almacén de certificados de Windows."},
...
{"R_InvalidAccessTokenCallbackClass","AccessTokenCallbackClass no válido: {0}"},
...
{"R_readCertError","Error al leer el certificado. Compruebe la ubicación del certificado."},
...
{"R_InvalidIPAddressPreference","La preferencia de dirección IP {0} no es válida."},
{"R_UnableLoadAuthDll","No se pueden cargar los DLL {0} de autenticación"},
{"R_illegalArgumentTrustManager","Error interno. La cadena de certificados del mismo nivel o el algoritmo de intercambio de claves no pueden ser nulos ni estar vacíos."},
{"R_serverCertExpired","El certificado de servidor ha expirado: {0}: {1}"},
{"R_serverCertNotYetValid","El certificado de servidor aún no es válido: : {0} {1}"},
{"R_serverCertError","Error al validar el certificado de servidor: {0}: \n{1}:\n{2}."},
{"R_SecureStringInitFailed","No se pudo inicializar SecureStringUtil para almacenar cadenas seguras"},
{"R_ALPNFailed","No se pudo negociar el protocolo de capa de aplicación {0}. Servidor devuelto: {1}."},
{"R_serverError","Error durante el comando actual (estado listo {0}). {1}"},
{"R_ManagedIdentityTokenAcquisitionFail","No se pudo adquirir el token de la identidad administrada. La solicitud del token se realizó correctamente, pero no se devolvió ningún token. El token es nulo."},
{"R_AmbiguousRowUpdate","No se pudo ejecutar updateRow(). La actualización está intentando una actualización ambigua en las tablas \"{0}\" y \"{1}\". Asegúrese de que todas las columnas que se actualizan antes de la llamada updateRow() pertenezcan a la misma tabla."},
{"R_InvalidSqlQuery","Consulta SQL no válida: {0}"},
};
}
