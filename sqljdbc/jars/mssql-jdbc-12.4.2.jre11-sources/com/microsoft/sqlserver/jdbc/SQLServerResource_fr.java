...
{"R_transactionsNotSupported","'@@TRANCOUNT' n’est pas pris en charge."},
...
{"R_sslFailed","La propriété « chiffrer » a la valeur « {0} » et la propriété « CertificatServeurApprouvé » a la valeur « {1} » mais le pilote n’a pas pu établir de connexion sécurisée à SQL Server à l’aide du chiffrement SSL (Secure Sockets Layer) : Erreur : {2}."},
...
{"R_clientCertificatePropertyDescription","Chemin d’accès du certificat client."},
{"R_clientKeyPropertyDescription","Chemin d’accès du fichier de clé privée pour le certificat client."},
...
{"R_accessTokenCallbackClassPropertyDescription","Classe à instancier en tant que SQLServerAccessTokenCallback pour l’acquisition de jetons."},
{"R_accessTokenCallbackPropertyDescription","Objet SQLServerAccessTokenCallback utilisé pour appeler une méthode de rappel afin de retourner un jeton d’accès."},
...
{"R_AccessTokenCannotBeEmpty","AccessToken ne peut pas être vide."},
...
{"R_NoUserOrCertForActiveServicePrincipalCertificate","Le mot clé de chaîne de connexion « UserName » et « clientCertificate » doit être spécifié, si « Authentication=ActiveDirectoryServicePrincipalCertificate »."},
...
{"R_VerifySignatureFailed","Impossible de vérifier la signature de la clé de chiffrement de colonne."},
{"R_SignatureNotMatch","La signature de clé de chiffrement de colonne chiffrée spécifiée « {0} » ne correspond pas à la signature « {1} » calculée avec la clé principale de colonne (certificat) dans « {2} ». Peut-être que la clé de chiffrement de colonne chiffrée est endommagée ou que le chemin spécifié est incorrect. {3}"},
{"R_CEKSignatureNotMatchCMK","La signature de la clé de chiffrement de la colonne chiffrée « {0} » ne correspond pas à la signature calculée avec la clé principale de colonne (clé asymétrique dans Azure Key Vault) dans {1}. La clé de chiffrement de la colonne chiffrée est peut-être endommagée ou le chemin spécifié est peut-être incorrect."},
...
{"R_InvalidWindowsCertificateStoreSignCMK","Impossible de signer les métadonnées de la clé principale de la colonne avec le magasin de certificats Windows."},
...
{"R_InvalidAccessTokenCallbackClass","AccessTokenCallbackClass non valide : {0}"},
...
{"R_readCertError","Erreur lors de la lecture du certificat. Vérifiez l’emplacement du certificat."},
...
{"R_serverCertExpired","Le certificat de serveur a expiré : {0}: {1}"},
{"R_serverCertNotYetValid","Le certificat de serveur n’est pas encore valide : {0}: {1}"},
{"R_serverCertError","Erreur lors de la validation du certificat de serveur : {0}: \n{1}:\n{2}."},
...
{"R_AmbiguousRowUpdate","Échec de l’exécution de updateRow(). La mise à jour tente une mise à jour ambiguë sur les tables « {0} » et « {1} ». Vérifiez que toutes les colonnes mises à jour avant l’appel updateRow() appartiennent à la même table."},
