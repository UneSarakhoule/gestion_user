...
{"R_useBulkCopyForBatchInsertPropertyDescription","Especifica se o driver usará a API de cópia em massa para operações de inserção em lotes"},
...
{"R_illegalArgumentTrustManager","Erro interno. A cadeia de certificados de pares ou o algoritmo de troca de chaves não podem ser nulos ou vazios."},
